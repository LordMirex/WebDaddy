        ...
        <div class="flex justify-between h-16 overflow-visible">
            ...
            <div class="flex items-center">
                <a href="/" class="flex items-center group" aria-label="<?= SITE_NAME ?> Home">
                    <img src="/assets/images/webdaddy-logo.png" alt="<?= SITE_NAME ?>" class="h-12 mr-3 group-hover:scale-110 transition-transform duration-300" loading="eager" decoding="async" onerror="this.src='/favicon.ico'">
