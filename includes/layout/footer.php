    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div class="mb-8 lg:mb-0 lg:grid lg:grid-cols-12 lg:gap-8 lg:items-start">
            ...
            <div class="lg:col-span-4">
                ...
                <div class="space-y-2 flex flex-col items-center lg:items-start">
                    <div class="flex items-center gap-1.5">
                        ...
                        <span class="text-gray-300 text-sm font-medium">Message on WhatsApp</span>
                    </div>
                    <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', getSetting('whatsapp_number', WHATSAPP_NUMBER)); ?>" 
                       target="_blank" rel="noopener noreferrer"
                       class="inline-flex items-center gap-1.5 text-green-400 hover:text-green-300 font-medium transition-colors text-sm">
