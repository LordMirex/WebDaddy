...
/**
 * Send affiliate opportunity invitation email to new customers on first purchase
 * Queues email to email_queue for reliable delivery
 * @param string $customerName Customer's name
 * @param string $customerEmail Customer's email
 * @return bool Success status
 */
function sendAffiliateOpportunityEmail($customerName, $customerEmail) {
    $subject = "🚀 Earn Money as a WebDaddy Empire Affiliate!";
    $affiliateUrl = defined('SITE_URL') ? SITE_URL . '/affiliate' : 'https://webdaddy.online/affiliate';
    
    $content = <<<HTML
<h2 style="color:#3b82f6; margin:0 0 15px 0; font-size:20px;">Become an Affiliate Partner</h2>
<p style="color:#374151; line-height:1.6; margin:0 0 15px 0;">
    Thank you for your first purchase with us! 🎉
</p>
<p style="color:#374151; line-height:1.6; margin:0 0 15px 0;">
    We'd like to invite you to join our <strong>Affiliate Program</strong> and start earning <strong>30% commission</strong> on every sale you refer!
</p>
<div style="background:#dbeafe; border-left:4px solid #3b82f6; padding:15px; border-radius:4px; margin:15px 0;">
    <p style="margin:0; color:#1e40af; font-weight:600;">💰 Why Join?</p>
    <ul style="margin:10px 0 0 0; padding-left:20px; color:#374151; line-height:1.8;">
        <li>Earn <strong>30% commission</strong> on every referral</li>
        <li>No limits on how much you can earn</li>
        <li>Dedicated affiliate dashboard to track earnings</li>
        <li>Monthly payouts via your preferred method</li>
        <li>Marketing materials provided to help you succeed</li>
    </ul>
</div>
<p style="color:#374151; line-height:1.6; margin:15px 0;">
    Join thousands of successful affiliates earning passive income by promoting our templates, domains, and tools!
</p>
<div style="text-align:center; margin:25px 0;">
    <a href="{$affiliateUrl}" style="background:#3b82f6; color:#ffffff; padding:12px 30px; border-radius:4px; text-decoration:none; display:inline-block; font-weight:600;">
        Join Affiliate Program
    </a>
</div>
<p style="color:#6b7280; line-height:1.6; margin:15px 0 0 0; font-size:13px;">
    Have questions? Reach out to us on WhatsApp - we're here to help!
</p>
HTML;
    
    $emailBody = createEmailTemplate($subject, $content, $customerName);
    
    // Queue email for reliable delivery instead of sending directly
    $db = getDb();
    if ($db) {
        try {
            $stmt = $db->prepare("
                INSERT INTO email_queue 
                (recipient_email, recipient_name, subject, body, email_type, status, created_at)
            ...
            error_log("Failed to queue affiliate opportunity email: " . $e->getMessage());
            return false;
        }
    }
