    ...
    <div class="max-w-md w-full">
        <div class="bg-gray-800 rounded-2xl shadow-2xl p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center mb-6">
                ...
                <a href="javascript:history.back()" class="inline-flex items-center justify-center px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold rounded-lg transition-colors">
            ...
            <div class="border-t border-gray-700 pt-4">
                <p class="text-gray-400 text-sm mb-3">Need help? Browse our templates:</p>
                <a href="/#templates" class="inline-flex items-center px-4 py-2 bg-gray-800 hover:bg-gray-700 text-primary-600 font-medium rounded-lg transition-colors text-sm">
