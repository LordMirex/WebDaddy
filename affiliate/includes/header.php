...
<head>
    ...
    <style>
        ...
        .affiliate-sidebar .nav-link {
            color: #495057;
            padding: 0.75rem 1rem;
            border-left: 3px solid transparent;
        }
        .affiliate-sidebar .nav-link:hover {
            background-color: #f8f9fa;
            color: #007bff;
        }
        .affiliate-sidebar .nav-link.active {
            color: #007bff;
            background-color: #e7f1ff;
            border-left-color: #007bff;
        }
        .affiliate-sidebar .nav-link i {
            margin-right: 0.5rem;
        }
    </style>
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="/affiliate/">
                <i class="bi bi-cash-stack"></i> <?php echo SITE_NAME; ?> Affiliate
            </a>
