    ...
    setupElements() {
        const containerHtml = `
            <div class="image-cropper-wrapper w-full max-w-2xl mx-auto">
                <div class="image-cropper-container relative w-full bg-black rounded-lg overflow-hidden" style="height: 350px;">
                ...
                <div class="image-cropper-controls mt-4 flex flex-col sm:flex-row gap-3 items-center">
                    ...
                    <div class="flex-1 w-full">
                        ...
                        <select class="aspect-ratio-select w-full px-3 py-2 border border-gray-300 rounded text-sm">
                    ...
                    <button class="reset-btn px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded">Reset</button>
                    <button class="crop-apply-btn px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded">Crop</button>
                </div>
            </div>
        `;
