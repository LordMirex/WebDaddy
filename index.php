        ...
        <div class="relative flex-1 flex flex-col md:flex-row items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-1 gap-4 md:gap-8">
            ...
            <div class="md:w-3/5 order-1 md:order-1">
                ...
                <div class="hidden md:flex flex-row gap-3 md:gap-4">
                    <button onclick="switchView('templates'); document.getElementById('products')?.scrollIntoView({behavior: 'smooth'}); return false;" class="btn-gold-shine flex items-center justify-center px-4 md:px-6 py-2.5 md:py-3 text-sm md:text-base font-semibold rounded-lg text-navy transition-all whitespace-nowrap">
                        <svg class="w-4 h-4 md:w-5 md:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"/>
                        </svg>
                        Browse Templates
                    </button>
                    <button onclick="switchView('tools'); document.getElementById('products')?.scrollIntoView({behavior: 'smooth'}); return false;" class="flex items-center justify-center px-4 md:px-6 py-2.5 md:py-3 text-sm md:text-base font-semibold rounded-lg text-gold border-2 border-gold-shine hover:bg-gold hover:text-navy transition-all whitespace-nowrap">
                        <svg class="w-4 h-4 md:w-5 md:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="md:hidden w-full order-3 flex flex-col gap-2 sm:gap-3">
                <button onclick="switchView('templates'); document.getElementById('products')?.scrollIntoView({behavior: 'smooth'}); return false;" class="btn-gold-shine flex items-center justify-center px-4 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold rounded-lg text-navy transition-all">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"/>
                    </svg>
                    Browse Templates
                </button>
                <button onclick="switchView('tools'); document.getElementById('products')?.scrollIntoView({behavior: 'smooth'}); return false;" class="flex items-center justify-center px-4 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold rounded-lg text-gold border-2 border-gold hover:bg-gold hover:text-navy transition-all">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                    </svg>
                    Explore Tools
    ...
    <section class="py-6 md:py-12 bg-navy-dark" id="products" x-cloak>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-br from-navy via-navy-light to-navy border-2 border-gold/30 rounded-2xl p-8 md:p-12 text-center shadow-lg">
                ...
                <h4 class="text-2xl md:text-3xl font-bold text-white mb-3">Looking for Something Special?</h4>
                <p class="text-gray-300 mb-6 max-w-md mx-auto leading-relaxed">We're constantly updating our collection with beautiful, high-converting website templates. Don't see what you're looking for? Let us know!</p>
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', WHATSAPP_NUMBER); ?>?text=<?php echo urlencode('Hi! I\'m looking for a custom website template. Can you help me find something that matches my needs?'); ?>" 
                       target="_blank"
                    ...
                    <button onclick="window.location.href='/?view=templates'; showNotification('Refresh to see latest templates', 'success');" 
                ...
                <p class="text-sm text-gray-500 mt-6">💡 Tip: Tell us your industry and we'll create the perfect template for you!</p>
            </div>
            <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6" data-templates-grid>
                ...
                <div class="group" 
                    ...
                    <div class="template-card group bg-navy-light rounded-lg md:rounded-xl shadow-md overflow-hidden border border-gray-700/50 transition-all duration-300 hover:shadow-xl hover:border-gold/30 hover:-translate-y-1 h-full flex flex-col" x-cloak>
                        ...
                        <div class="p-3 md:p-4 flex-1 flex flex-col">
                            ...
                            <p class="text-gray-400 text-[11px] md:text-xs mb-2 md:mb-3 line-clamp-2 min-h-[24px] md:min-h-[32px] flex-1"><?php echo htmlspecialchars($descText); ?></p>
                            <?php endif; ?>
                            <div class="flex items-center justify-between pt-2 md:pt-3 border-t border-gray-700/50 mt-auto">
                                ...
                                <div class="flex gap-1.5 md:gap-2 relative z-10 pointer-events-auto">
                                    <a href="<?php echo getTemplateUrl($template, $affiliateCode); ?>" 
                                       class="inline-flex items-center justify-center px-2.5 md:px-4 py-1.5 md:py-2 border border-gray-600 text-[10px] md:text-xs font-semibold rounded-md md:rounded-lg text-gray-300 bg-transparent hover:bg-navy hover:border-gray-500 transition-all whitespace-nowrap pointer-events-auto cursor-pointer">
                                        Details
                                    </a>
                                    <button onclick="addTemplateToCart(<?php echo $template['id']; ?>, '<?php echo addslashes($template['name']); ?>', this)" 
                                       class="inline-flex items-center justify-center px-2.5 md:px-4 py-1.5 md:py-2 border border-transparent text-[10px] md:text-xs font-semibold rounded-md md:rounded-lg text-navy bg-gold hover:bg-gold-500 transition-all whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed pointer-events-auto cursor-pointer">
            ...
            <div class="bg-gradient-to-br from-navy via-navy-light to-navy border-2 border-gold/30 rounded-2xl p-8 md:p-12 text-center shadow-lg">
                ...
                <h4 class="text-2xl md:text-3xl font-bold text-white mb-3">Premium Tools Coming Soon!</h4>
                <p class="text-gray-300 mb-6 max-w-md mx-auto leading-relaxed">We're curating the best digital tools and resources for your business. Need something specific? Let us build it for you or recommend the perfect solution.</p>
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', WHATSAPP_NUMBER); ?>?text=<?php echo urlencode('Hi! I\'m looking for specific digital tools for my business. Can you help me find or create the right solution?'); ?>" 
                       target="_blank"
                       class="inline-flex items-center justify-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-all shadow-md hover:shadow-lg transform hover:scale-105">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                    ...
                    <button onclick="window.location.href='/?view=templates';" 
                            class="inline-flex items-center justify-center px-6 py-3 bg-gold hover:bg-gold-600 text-navy font-semibold rounded-lg transition-all shadow-md hover:shadow-lg transform hover:scale-105">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                        </svg>
                ...
                <p class="text-sm text-gray-500 mt-6">✨ We create custom solutions tailored to your business needs!</p>
            </div>
            <?php else: ?>
