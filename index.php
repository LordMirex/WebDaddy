...
<body class="bg-gray-50">
    ...
    class="fixed bottom-4 left-0 z-50">
        <a :href="'https://wa.me/<?php echo preg_replace('/[^0-9]/', '', WHATSAPP_NUMBER); ?>?text=' + encodeURIComponent(getContextualMessage())" 
           target="_blank"
           class="relative block bg-green-600 hover:bg-green-700 rounded-r-full shadow-lg hover:shadow-xl transition-all duration-300"
           aria-label="Chat on WhatsApp">
            <!-- Fixed Width Icon Container -->
            <div class="flex items-center justify-center w-14 h-14 pl-3">
            ...
            <!-- Absolutely Positioned Message Pill -->
            <div x-show="showMessage" 
                 ...
                 class="absolute left-14 top-1/2 -translate-y-1/2 bg-green-600 text-white font-semibold text-sm whitespace-nowrap px-4 py-3 rounded-r-full pointer-events-none">
