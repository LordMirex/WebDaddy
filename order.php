        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            <div class="lg:col-span-2">
                ...
                <?php if (empty($error)): ?>
                    ...
                    <div class="bg-gradient-to-r from-amber-50 to-orange-50 border border-orange-200 rounded-lg p-4 mb-6" id="discountSection">
                        <?php if ($hasAffiliate): ?>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-semibold text-green-800">20% OFF Applied! Code: <?php echo htmlspecialchars($affiliateCode); ?></span>
                            </div>
                            <span class="text-sm font-bold text-green-700">Saves <?php echo formatCurrency($discountAmount); ?></span>
                        </div>
                        <?php else: ?>
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-gray-900 mb-1">Save 20% with a discount code!</p>
                                <div class="flex gap-2" id="affiliateForm">
                                    <input type="text" 
                                           class="flex-1 px-3 py-2 text-sm border <?php echo $affiliateInvalid ? 'border-red-500' : 'border-gray-300'; ?> rounded-md focus:ring-2 focus:ring-orange-500 focus:border-transparent uppercase" 
                                           id="affiliate_code" 
                                           value="<?php echo htmlspecialchars($submittedAffiliateCode); ?>" 
                                           placeholder="ENTER CODE"
                                           autocomplete="off">
                                    <button class="px-4 py-2 text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 transition-colors whitespace-nowrap" 
                                            type="button"
                                ...
                                <?php if ($affiliateInvalid): ?>
                                    <p class="mt-2 text-xs text-red-600" id="affiliateError">Invalid code. Please check and try again.</p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
